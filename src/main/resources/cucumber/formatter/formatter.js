...
CucumberHTML.DOMFormatter = function(rootNode) {
  ...
  (function()
  {
    $('.cucumber-report').append( '<div id="cucumber-header"><div id="label"><h1><a href="http://www.uksa.eu">UKSA<a/> Cucumber Acceptance Testing</h1></div><div id="summary"><p id="totals"></p><p id="duration"></div>' );
    $('.cucumber-report').append( '<div id="collapse" class="collapse"><a href="javascript:collapseDetails();">Collapse</a>/<a href="javascript:expandDetails();">Expand</a></div>' );
  })();
  ...
  function collapseDetails() {
    ...
    for (var i = 0; i < list.length; i++){
      list.item(i).removeAttribute('open');
    }
  }
